    ...
    <div className="max-w-6xl mx-auto animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-6 shadow-lg border border-gray-100">
            ...
            <div className="space-y-4">
              <div className="bg-white/50 rounded-lg p-4">
                ...
                <p className="text-gray-700 text-sm">{results.socialPosts.linkedin}</p>
              </div>
              ...
              <div className="bg-white/50 rounded-lg p-4">
                ...
                <p className="text-gray-700 text-sm">{results.socialPosts.twitter}</p>
              </div>
            </div>
          </div>
        </div>
